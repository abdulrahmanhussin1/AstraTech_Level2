                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">Data code</th>
                                    <th scope="col" class="text-center">MainData</th>
                                ...
                                @foreach ($mappingData as $mpData)
                                    <tr>
                                        <form action="{{ route('mapData') }}" method="POST">
                                            ...
                                            <td class="w-25">{{ $mpData->description }}</td>
                                            <td class="text-center">{{ $mpData->id }}</td>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-select" name="mainData_id"
                                                            ...
                                                            <option value="{{ null }}">Choose to Map with Main data
                                                            </option>
                                                            @foreach ($mainData as $data)
                                            ...
                                            <td class="text-center">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-select" name="condition"
                                                            aria-label="Default select example" required>
                                                            <option value="{{ null }}">Choose Data Condition
                                                            </option>
                                                            <option value="A">A</option>
                                                            <option value="B">B</option>
                                                            <option value="C">C</option>
